...
import {UploadAdapter} from './ckeditor.adaptor';

@Component({
    selector: 'iw-ckeditor',
    templateUrl: './iw-dropzone.component.html',
    providers: [MakeProvider(IwCkeditorComponent)]
})
export class IwCkeditorComponent extends AbstractValueAccessor implements OnInit, AfterContentChecked {
    ...
    public ckeditorOnReady(editor) {
        ...
        editor.plugins.get('FileRepository').createUploadAdapter = function (loader) {
            ...
            return new UploadAdapter(loader, this.httpClient, this.token);
        };
    }
}
